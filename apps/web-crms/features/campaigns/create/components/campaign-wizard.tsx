...
import { Step1Channels } from "./step1-channels";
import { Step2Audience, SYSTEM_PRESET_SEGMENTS } from "./step2-audience";
import { Step3Content } from "./step3-content";
import { StepReview } from "./step-review";
import { CampaignCancelModal } from "../../details/components/campaign-cancel-modal";
...
import {
  ...
  STEP_PHASE,
  type Step,
} from "../hooks/use-campaign-wizard-state";
        ...
        <CardContent className="p-6">
          ...
          {step === "Schedule" && (
            <ScheduleStep
              ...
              value={schedule}
              onChange={(patch) => setSchedule((prev: ScheduleState) => ({ ...prev, ...patch }))}
            />
          )}
