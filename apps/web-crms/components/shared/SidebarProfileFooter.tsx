  ...
  return (
    <div className="w-full">
      <DropdownMenu>
        ...
        <DropdownMenuContent className="w-64 bg-popover border-border text-popover-foreground z-[99999] shadow-xl p-sm fixed left-[96px]" side="right" align="end" sideOffset={8}>
