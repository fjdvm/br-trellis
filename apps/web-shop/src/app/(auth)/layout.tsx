    ...
    <Providers>
      <div className="min-h-screen bg-[var(--surface)] flex flex-col relative overflow-x-hidden">
        ...
        <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
          <div className="absolute -top-[10%] -left-[10%] w-[40%] h-[40%] bg-[var(--primary)]/5 blur-[120px]" />
          <div className="absolute -bottom-[10%] -right-[10%] w-[40%] h-[40%] bg-[var(--secondary)]/5 blur-[120px]" />
        </div>
